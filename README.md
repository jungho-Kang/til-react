...
- 코딩할 때 `도메인`을 지켜서 `업무를 식별`해서 개발하세요
- `DNS`는 `Domain Name System`로서

### 2.3. Port 번호

- `:3000`
- `80` port는 기본 포트입니다 (도메인으로 접속시 자동연결)
  - 80은 안적으면 작동
...
- `http://localhost:3000/` Root페이지 또는 라우터
...
- `Router의 Outlet 장소`에 `path`에 따라서 `컴포넌트 출력`
- 반드시 `중첩 Router여야 가능`
- 샘플 예제
